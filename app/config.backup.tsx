...
export default function SettingsScreen() {
  ...
  const loadStorageStats = async () => {
    try {
      ...
      const supplementsHistory = supplementsHistoryJSON
        ? JSON.parse(supplementsHistoryJSON)
        : {};

      // Contar entradas de suplementos
      const supplementEntries = Object.keys(supplementsHistory).reduce(
        (total, date) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        ...
        <Pressable
          style={[styles.linkCard, styles.cloudCard]}
        ...
        >
          ...
          <View style={styles.cardTextContainer}>
            <Text style={styles.cardTitle}>Planejar Semana</Text>
            <Text style={styles.cardSubtitle}>
